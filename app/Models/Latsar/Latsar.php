...
class Latsar extends Model
{
    ...
    public static function datatable(Request $request): mixed
    {
        ...
        $c_dibuka_str = 'dibuka_str';
        $query[$c_dibuka_str] = <<<SQL
                (if($table.dibuka = 1, 'Dibuka', 'Ditutup'))
        SQL;
        $query["{$c_dibuka_str}_alias"] = $c_dibuka_str;
        // ========================================================================================================
