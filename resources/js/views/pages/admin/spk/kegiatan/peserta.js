    ...
    const new_table = table_html.DataTable({
...

        {
            ...
            render(data, type, full, meta) {
                return data ? `
                    <img class="table-foto" src="${full.ktp_link}" alt="${full.nama}" onclick="viewImage('${full.ktp_link}', '${full.nama}')">
                    ` : '';
            },
            orderable: false
        },
        {
            ...
            name: 'nama',
            render(data, type, full, meta) {
                return `${data}<br><small>${full.nik}</small>`;
            },
        },
        {
            data: 'email',
...
function editFunc(id) {
    ...
    $.ajax({
        ...
        success: (data) => {
            ...
            $('#lihat-ktp').fadeIn();
            $('#lihat-ktp').attr('onclick', `viewImage('${data.ktp_link}', '${data.nama}' )`);
