                        ...
                        <div class="accordion-body">
                            <form action="javascript:void(0)" class="ml-md-3 mb-md-3" id="FilterForm">
                                <div class="form-group float-start me-2" style="width: 250px">
                                    <label for="filter_dibuka">Pendaftaran Dibuka</label>
                                    <br>
                                    <select class="form-control" id="filter_dibuka" name="filter_dibuka"
                                        style="width: 250px">
                ...
                <div class="modal-body">
                    <form action="javascript:void(0)" id="MainForm" name="MainForm" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="angkatan_sekarang">Tahun Angkatan</label>
                                    <input type="number" class="form-control" id="angkatan_sekarang"
                                        name="angkatan_sekarang" placeholder="Tahun Angkatan" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="dibuka">Pendaftaran Dibuka</label>
                                    <select class="form-control" id="dibuka" name="dibuka" required>
                                        <option value="1">Dibuka</option>
                                        <option value="0">Ditutup</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea cols="3" rows="4" class="form-control summernote" id="deskripsi" name="deskripsi"
